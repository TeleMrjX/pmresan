function run(msg)
	...
	about_key = {{text = "کانال تیم آمبرلا" , url = "https://telegram.me/MrLammer"}},{{text = "پیام رسان سازنده" , url = "https://telegram.me/shayansoftBot"}},{{text = "مهندس شایان احمدی" , url = "https://telegram.me/shayan_soft"}}}
	...
	start_key = {{{text="ساخت ربات پیام رسان",url="https://telegram.me/MrLammerBot"}}}
...
function inline(msg)
	...
	bioinfo = infotxtin.."*Name:* "..sudo_name.."\n*Username:* [@"..sudo_user.."](https://telegram.me/"..sudo_user..")\n*Mobile:* +"..sudo_num.."\n*Telegram ID:* "..sudo_id.."\n*Channel:* [@"..sudo_ch.."](https://telegram.me/"..sudo_ch..")\n\n_Powered by_ [Umbrella Team](https://telegram.me/LammerTeam)"
	tabless = '[{"text":"اکانت اصلی من","url":"https://telegram.me/'..sudo_user..'"}],[{"text":"کانال شخصی من","url":"https://telegram.me/'..sudo_ch..'"}],[{"text":"کانال سازنده","url":"https://telegram.me/LammerTeam"},{"text":"سازنده ربات","url":"https://telegram.me/MrLammer"}]'
